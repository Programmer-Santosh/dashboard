      ...
      <div className="head">
        ...
        <p className="header">Santosh Thapa</p>
          ...
          <p className="green">&#x2022; </p>
            ...
            <p className="outputMessage" id="output" style={{visibility : submittedMessage===""?"hidden":"visible"}}>{submittedMessage}</p>
            <textarea className="message" id="message-support" value={message} placeholder="Enter Your Issue on Message"onChange={handleInputChange}/>
           
            <button onClick={handleSendMessage} type="submit" id="sendMessageBtn">Send Message</button>
        </div>
